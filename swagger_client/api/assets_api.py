...
class AssetsApi(object):
    ...
    def get_asset(self, id, **kwargs):  # noqa: E501
        ...
        Image typed files can be dynamically resized and transformed to fit any need.  # noqa: E501
        ...
        :param str key: The key of the asset size configured in settings.
        :param str transforms: A JSON array of image transformations
        :param bool download: Download the asset to your computer
        :return: str
    ...
    def get_asset_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'key', 'transforms', 'download']  # noqa: E501
        ...
        if 'transforms' in params:
            query_params.append(('transforms', params['transforms']))  # noqa: E501
