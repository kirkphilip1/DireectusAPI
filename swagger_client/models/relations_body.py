...
class RelationsBody(object):
    ...
    def __init__(self, collection_many=None, collection_one=None, field_many=None, field_one=None, junction_field=None):  # noqa: E501
        """RelationsBody - a model defined in Swagger"""  # noqa: E501
    ...
    def collection_many(self):
        """Gets the collection_many of this RelationsBody.  # noqa: E501

        Collection that has the field that holds the foreign key.  # noqa: E501

        :return: The collection_many of this RelationsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def collection_many(self, collection_many):
        """Sets the collection_many of this RelationsBody.

        Collection that has the field that holds the foreign key.  # noqa: E501

        :param collection_many: The collection_many of this RelationsBody.  # noqa: E501
        :type: str
        """
    ...
    def collection_one(self):
        """Gets the collection_one of this RelationsBody.  # noqa: E501

        Collection on the _one_ side of the relationship.  # noqa: E501

        :return: The collection_one of this RelationsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def collection_one(self, collection_one):
        """Sets the collection_one of this RelationsBody.

        Collection on the _one_ side of the relationship.  # noqa: E501

        :param collection_one: The collection_one of this RelationsBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def field_many(self):
        """Gets the field_many of this RelationsBody.  # noqa: E501

        Foreign key. Field that holds the primary key of the related collection.  # noqa: E501

        :return: The field_many of this RelationsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def field_many(self, field_many):
        """Sets the field_many of this RelationsBody.

        Foreign key. Field that holds the primary key of the related collection.  # noqa: E501

        :param field_many: The field_many of this RelationsBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def field_one(self):
        """Gets the field_one of this RelationsBody.  # noqa: E501

        Alias column that serves as the _one_ side of the relationship.  # noqa: E501

        :return: The field_one of this RelationsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def field_one(self, field_one):
        """Sets the field_one of this RelationsBody.

        Alias column that serves as the _one_ side of the relationship.  # noqa: E501

        :param field_one: The field_one of this RelationsBody.  # noqa: E501
        :type: str
        """
    ...
    def junction_field(self):
        """Gets the junction_field of this RelationsBody.  # noqa: E501

        Field on the junction table that holds the primary key of the related collection.  # noqa: E501

        :return: The junction_field of this RelationsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def junction_field(self, junction_field):
        """Sets the junction_field of this RelationsBody.

        Field on the junction table that holds the primary key of the related collection.  # noqa: E501

        :param junction_field: The junction_field of this RelationsBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RelationsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RelationsBody):
            return False
