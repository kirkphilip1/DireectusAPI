...
# **create_webhook**
> InlineResponse20035 create_webhook(body=body, fields=fields, meta=meta)
...
# **get_webhook**
> InlineResponse20041 get_webhook(id)
...
# **get_webhooks**
> InlineResponse20041 get_webhooks()
...
# **update_webhook**
> InlineResponse20035 update_webhook(id, body=body, fields=fields, meta=meta)
...
# **update_webhooks**
> InlineResponse20042 update_webhooks(body=body, fields=fields, limit=limit, meta=meta, offset=offset, sort=sort, filter=filter, search=search)
