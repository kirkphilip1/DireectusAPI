...
# **create_role**
> InlineResponse20035 create_role(body=body, fields=fields, meta=meta)
...
# **get_role**
> InlineResponse20035 get_role(id, fields=fields, meta=meta)
...
# **get_roles**
> InlineResponse20034 get_roles(fields=fields, limit=limit, offset=offset, meta=meta, sort=sort, filter=filter, search=search, page=page)
...
# **update_role**
> InlineResponse20035 update_role(id, body=body, fields=fields, meta=meta)
...
# **update_roles**
> InlineResponse20034 update_roles(body=body, fields=fields, limit=limit, meta=meta, offset=offset, sort=sort, filter=filter, search=search)
